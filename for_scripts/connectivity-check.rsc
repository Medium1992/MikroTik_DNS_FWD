...
:if ([:len [find name="msftconnecttest.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" match-subdomain=yes type=FWD name="msftconnecttest.com" }
...
:if ([:len [find name="test.steampowered.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" match-subdomain=yes type=FWD name="test.steampowered.com" }
:if ([:len [find name="conn1.oppomobile.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" type=FWD name="conn1.oppomobile.com" }
:if ([:len [find name="conn2.oppomobile.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" type=FWD name="conn2.oppomobile.com" }
...
:if ([:len [find name="connectivitycheck.gstatic.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" type=FWD name="connectivitycheck.gstatic.com" }
...
:if ([:len [find name="edge-http.microsoft.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" type=FWD name="edge-http.microsoft.com" }
:if ([:len [find name="networkcheck.kde.org"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" type=FWD name="networkcheck.kde.org" }
