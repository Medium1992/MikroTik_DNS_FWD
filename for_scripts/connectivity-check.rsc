...
:if ([:len [find name="connectivitycheck.gstatic.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="connectivity-check" match-subdomain=yes type=FWD name="connectivitycheck.gstatic.com" }
