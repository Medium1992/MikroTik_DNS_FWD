...
:global ForwardTo
/ip dns static
:if ([:len [find name="ai.studio"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="ai.studio" }
:if ([:len [find name="aicode.googleapis.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="aicode.googleapis.com" }
...
:if ([:len [find name="flow.google"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="flow.google" }
:if ([:len [find name="flow.google.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="flow.google.com" }
...
:if ([:len [find name="jules.google.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="jules.google.com" }
...
:if ([:len [find name="notebook.google"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="notebook.google" }
...
:if ([:len [find name="opal.google.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="opal.google.com" }
:if ([:len [find name="proactivebackend-pa.googleapis.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="proactivebackend-pa.googleapis.com" }
:if ([:len [find name="robinfrontend-pa.googleapis.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="robinfrontend-pa.googleapis.com" }
:if ([:len [find name="stitch.withgoogle.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="google-deepmind" match-subdomain=yes type=FWD name="stitch.withgoogle.com" }
