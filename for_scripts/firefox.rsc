...
:if ([:len [find name="firefox-portal-detection.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="firefox" match-subdomain=yes type=FWD name="firefox-portal-detection.com" }
