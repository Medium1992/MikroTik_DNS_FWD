...
:global ForwardTo
/ip dns static
:if ([:len [find name="18eighteen.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="18eighteen.com" }
:if ([:len [find name="40somethingmag.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="40somethingmag.com" }
:if ([:len [find name="50plusmilfs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="50plusmilfs.com" }
...
:if ([:len [find name="bonedathome.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="bonedathome.com" }
:if ([:len [find name="bootyliciousmag.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="bootyliciousmag.com" }
:if ([:len [find name="bustyangelique.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="bustyangelique.com" }
:if ([:len [find name="bustyarianna.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="bustyarianna.com" }
:if ([:len [find name="bustydanniashe.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="bustydanniashe.com" }
:if ([:len [find name="bustydustystash.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="bustydustystash.com" }
...
:if ([:len [find name="codivorexxx.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="codivorexxx.com" }
:if ([:len [find name="creampieforgranny.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="creampieforgranny.com" }
:if ([:len [find name="crystalgunnsworld.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="crystalgunnsworld.com" }
...
:if ([:len [find name="flatandfuckedmilfs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="flatandfuckedmilfs.com" }
:if ([:len [find name="getscorecash.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="getscorecash.com" }
...
:if ([:len [find name="joanabliss.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="joanabliss.com" }
...
:if ([:len [find name="megatitsminka.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="megatitsminka.com" }
:if ([:len [find name="mickybells.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="mickybells.com" }
:if ([:len [find name="milfbundle.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="milfbundle.com" }
:if ([:len [find name="milfthreesomes.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="milfthreesomes.com" }
:if ([:len [find name="milftugs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="milftugs.com" }
:if ([:len [find name="millymarks.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="millymarks.com" }
:if ([:len [find name="mommystoytime.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="mommystoytime.com" }
:if ([:len [find name="nataliefiore.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="nataliefiore.com" }
:if ([:len [find name="naughtyfootjobs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="naughtyfootjobs.com" }
:if ([:len [find name="naughtymag.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="naughtymag.com" }
:if ([:len [find name="naughtytugs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="naughtytugs.com" }
:if ([:len [find name="nicolepeters.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="nicolepeters.com" }
:if ([:len [find name="oldhornymilfs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="oldhornymilfs.com" }
:if ([:len [find name="pickinguppussy.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="pickinguppussy.com" }
...
:if ([:len [find name="scoreland.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="scoreland.com" }
:if ([:len [find name="scoreland2.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="scoreland2.com" }
:if ([:len [find name="scorepass.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="scorepass.com" }
:if ([:len [find name="scoretv.tv"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="scoretv.tv" }
:if ([:len [find name="scoreuniverse.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="scoreuniverse.com" }
:if ([:len [find name="scorevideos.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="scorevideos.com" }
:if ([:len [find name="sharizelvideos.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="sharizelvideos.com" }
:if ([:len [find name="silversluts.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="silversluts.com" }
:if ([:len [find name="stacyvandenbergboobs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="stacyvandenbergboobs.com" }
:if ([:len [find name="susiewildin.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="susiewildin.com" }
:if ([:len [find name="tawny-peaks.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="tawny-peaks.com" }
:if ([:len [find name="tiffany-towers.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="tiffany-towers.com" }
:if ([:len [find name="titsandtugs.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="titsandtugs.com" }
:if ([:len [find name="tnatryouts.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="tnatryouts.com" }
:if ([:len [find name="valoryirene.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="valoryirene.com" }
:if ([:len [find name="xlgirls.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="xlgirls.com" }
:if ([:len [find name="yourmomlovesanal.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="yourmomlovesanal.com" }
:if ([:len [find name="yourmomsgotbigtits.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="yourmomsgotbigtits.com" }
:if ([:len [find name="yourwifemymeat.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="thescoregroup" match-subdomain=yes type=FWD name="yourwifemymeat.com" }
