...
:if ([:len [find name="lastfm-img.freetls.fastly.net"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="lastfm" type=FWD name="lastfm-img.freetls.fastly.net" }
