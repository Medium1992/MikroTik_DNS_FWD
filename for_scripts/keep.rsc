...
:global ForwardTo
/ip dns static
:if ([:len [find name="calorietech.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="keep" match-subdomain=yes type=FWD name="calorietech.com" }
...
:if ([:len [find name="keep.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="keep" match-subdomain=yes type=FWD name="keep.com" }
