...
:if ([:len [find name="ads3-normal.zijieapi.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="fqnovel@ads" type=FWD name="ads3-normal.zijieapi.com" }
...
:if ([:len [find name="ads5-normal.zijieapi.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="fqnovel@ads" type=FWD name="ads5-normal.zijieapi.com" }
...
:if ([:len [find name="log3-applog.fqnovel.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="fqnovel@ads" type=FWD name="log3-applog.fqnovel.com" }
...
:if ([:len [find name="log5-applog.fqnovel.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="fqnovel@ads" type=FWD name="log5-applog.fqnovel.com" }
...
:if ([:len [find name="rtlog3-applog.fqnovel.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="fqnovel@ads" type=FWD name="rtlog3-applog.fqnovel.com" }
...
:if ([:len [find name="rtlog5-applog.fqnovel.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="fqnovel@ads" type=FWD name="rtlog5-applog.fqnovel.com" }
