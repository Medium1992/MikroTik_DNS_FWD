...
:if ([:len [find name="api.e.mindbox.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="mindbox" match-subdomain=yes type=FWD name="api.e.mindbox.ru" }
...
:if ([:len [find name="api.s.mindbox.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="mindbox" match-subdomain=yes type=FWD name="api.s.mindbox.ru" }
