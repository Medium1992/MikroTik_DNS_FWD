...
:global ForwardTo
/ip dns static
:if ([:len [find name="dailym.ai"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dailymail" match-subdomain=yes type=FWD name="dailym.ai" }
:if ([:len [find name="dailymail.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="dailymail" match-subdomain=yes type=FWD name="dailymail.com" }
