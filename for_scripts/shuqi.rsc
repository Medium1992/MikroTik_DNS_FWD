...
:if ([:len [find name="newstjk.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="shuqi" match-subdomain=yes type=FWD name="newstjk.com" }
...
:if ([:len [find name="shuqistat.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="shuqi" match-subdomain=yes type=FWD name="shuqistat.com" }
