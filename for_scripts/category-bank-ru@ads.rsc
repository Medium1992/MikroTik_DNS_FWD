...
:if ([:len [find name="metrics.21-school.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-bank-ru@ads" match-subdomain=yes type=FWD name="metrics.21-school.ru" }
