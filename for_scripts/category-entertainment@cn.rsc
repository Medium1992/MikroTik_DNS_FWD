...
:if ([:len [find name="shanghaidisneyresort.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" match-subdomain=yes type=FWD name="shanghaidisneyresort.com" }
...
:if ([:len [find name="amp-api-edge.music.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="amp-api-edge.music.apple.com" }
:if ([:len [find name="amp-api.music.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="amp-api.music.apple.com" }
:if ([:len [find name="amp-api.podcasts.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="amp-api.podcasts.apple.com" }
...
:if ([:len [find name="js-cdn.music.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="js-cdn.music.apple.com" }
...
:if ([:len [find name="music.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="music.apple.com" }
:if ([:len [find name="musicstatus.music.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="musicstatus.music.apple.com" }
...
:if ([:len [find name="play-edge.itunes.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="play-edge.itunes.apple.com" }
...
:if ([:len [find name="play.music.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="play.music.apple.com" }
:if ([:len [find name="podcasts.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="podcasts.apple.com" }
:if ([:len [find name="podcasts.itunes.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="podcasts.itunes.apple.com" }
...
:if ([:len [find name="speedysub.music.apple.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="category-entertainment@cn" type=FWD name="speedysub.music.apple.com" }
