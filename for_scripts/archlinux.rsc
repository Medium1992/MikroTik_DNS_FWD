...
:if ([:len [find name="archlinux.page"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="archlinux" match-subdomain=yes type=FWD name="archlinux.page" }
