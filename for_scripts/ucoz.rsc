...
:global ForwardTo
/ip dns static
:if ([:len [find name="narod.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="ucoz" match-subdomain=yes type=FWD name="narod.ru" }
...
:if ([:len [find name="ucozmail.com"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="ucoz" match-subdomain=yes type=FWD name="ucozmail.com" }
...
:if ([:len [find name="uguide.su"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="ucoz" match-subdomain=yes type=FWD name="uguide.su" }
...
:if ([:len [find name="ukoz.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="ucoz" match-subdomain=yes type=FWD name="ukoz.ru" }
:if ([:len [find name="usocial.pro"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="ucoz" match-subdomain=yes type=FWD name="usocial.pro" }
:if ([:len [find name="uweb.ru"]] = 0) do={ add address-list=$AddressList forward-to=$ForwardTo comment="ucoz" match-subdomain=yes type=FWD name="uweb.ru" }
